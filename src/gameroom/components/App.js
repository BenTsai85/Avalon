...
let default_player={img:'https://scontent-tpe1-1.xx.fbcdn.net/v/t1.0-9/12742136_736274853140630_5037882521848371900_n.jpg?oh=5753439b51912ba5823f002ec5909984&oe=58C1FA98'
	    		 ,name:'default' ,is_chief:false ,is_ready:false};
	...
	componentWillMount() {
	    ...
	    fetch('/api/gamelobby', { // get user
	    	...
	    	.then(res => {
	    		...
	    		var myself = {img:'https://scontent-tpe1-1.xx.fbcdn.net/v/t1.0-9/12742136_736274853140630_5037882521848371900_n.jpg?oh=5753439b51912ba5823f002ec5909984&oe=58C1FA98'
	    		 ,name:res.name ,is_chief:false ,is_ready:false};
